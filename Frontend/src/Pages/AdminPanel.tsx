...
import { getQuestions, createQuestions } from '../services/api';
...
function AdminPanel() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      // Add API call to create a new question here
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8">Admin Panel - Quiz Questions</h1>
