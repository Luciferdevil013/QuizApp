    ...
    <div className='w-full h-full flex items-center justify-center'>
      <div className='w-1/4 h-3/4 bg-slate-200 rounded-md px-4 flex flex-col justify-center gap-4'>
        <div className='w-full h-auto flex flex-col gap-2'>
          ...
          <input className='w-full text-lg font-medium p-1 rounded border-none outline-none' type="text" placeholder='Enter Your Name' />
        </div>
        ...
        <div className='w-full h-auto flex mt-4'>
          <a href="#" className='text-black-300 text-lg'>Back to Login Page</a>
        </div>
      </div>
    </div>
  )
